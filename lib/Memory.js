...
function lintOptions(options) {
  ...
  if (options.rootDir) newOptions.rootdir = options.rootDir;
  if (!options.rootdir) {
    console.log('use default memory rootdir');
